...
<section className="relative flex flex-wrap lg:h-screen lg:items-center">
  <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24">
    <div className="mx-auto max-w-lg text-center">
      ...
      Manage your account and access your resources easily.
      </p>
    </div>
  ...
  <div className="relative h-64 w-full sm:h-96 lg:h-full lg:w-1/2">
    <img
      alt="error"
     src="https://img.freepik.com/free-vector/tablet-login-concept-illustration_114360-7963.jpg?t=st=1733455022~exp=1733458622~hmac=657ee180f8638ef1d4cd9fc9d23541ab4dc90953705cdb55099d5d8dce14798b72&w=740"
