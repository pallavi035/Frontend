...
//                 <select className='px-4 py-2 w-full' name="" id="">
...
//                 <input className='py-2 px-4 w-full' type="text" name='city' placeholder='enter the city..' />
//               </div>
//             </div>
//             <div className='flex md:flex-row flex-col  gap-3 items-center mb-3'>
//               <div className='w-1/2'>
//                 <label className='text-white' htmlFor="">ShiftAndSchedule</label><br />
//                 <input className='py-2 px-4 mx-2 w-full' type="text" placeholder='ex:- monday-saturday' />
//               </div>
//               <div className='w-1/2'>
//                 <label className='text-white' htmlFor="">Last date of apply</label><br />
//                 <input className='py-2 px-4 mx-2 w-full' type="date" placeholder='' />
//               </div>
//             </div>
